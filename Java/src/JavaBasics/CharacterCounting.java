...
public class CharacterCounting {
    public static void main(String[] args) {    // Main method
        CharacterCounting obj = new CharacterCounting();      // Creating an object of the class
        ...
        obj.characterCounter(sortedString);     // Calling the method to calculate the character count
    }
    ...
    public void characterCounter(String data) {      // Method to calculate the repeated characters and its count
        ...
        System.out.println("\nCount of the repeated characters in the string:\n" + result);      // Printing the results
    }
}