...
public class w171 {
    public static void main(String[] args) {
        w171 obj = new w171();  // Creating an object to call the method
        ...
        System.out.println("Checking if the 2nd sentence contains any similar words: "+obj.comparingStrings(sentence1, sentence2));
    }
