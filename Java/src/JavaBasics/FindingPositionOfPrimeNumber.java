...
public class FindingPositionOfPrimeNumber {
    public static void main(String[] args) {    // Main method
        FindingPositionOfPrimeNumber obj = new FindingPositionOfPrimeNumber();      // Creating a class object
        ...
        if (!obj.isPrime(primeNumber)) {    // Condition to check if the number is prime or not
            ...
            System.out.println("\nThe position of the prime number is " + obj.findingPosition(primeNumber));    // Displaying the position of the prime number
        }
    }
    ...
    public int findingPosition(int value) {   // Method to find the position of the prime number
