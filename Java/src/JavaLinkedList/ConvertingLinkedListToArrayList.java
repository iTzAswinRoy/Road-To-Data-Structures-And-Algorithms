...
public class ConvertingLinkedListToArrayList {
    ...
    ConvertingLinkedListToArrayList() {        // Creating a default constructor
    ...
    public ArrayList<Integer> convertToArrayList(ConvertingLinkedListToArrayList linkedList) {        // Method to convert linked list into array list
        Node temp = linkedList.head;        // Creating a 'temp' node pointing at head of the linked list
        ArrayList<Integer> arrayList = new ArrayList<>();           // Creating a new array list

        // Iterating through the linked list
        for (int i = 0; i < size; i++) {
            arrayList.add(temp.value);          // Adding elements in the arraylist for each iteration
    ...
    public static void main(String[] args) {        // Main method
        ...
        ConvertingLinkedListToArrayList linkedList = new ConvertingLinkedListToArrayList();
        ...
        // Storing the values of the array list by calling the convert method
        ArrayList<Integer> result = linkedList.convertToArrayList(linkedList);
