...
public class GettingLastElement {
    ...
    GettingLastElement() {        // Creating a default constructor
    ...
    public int retrieveLast() {      // Method to retrieve the last element in the linked ist
        Node temp = tail;       // Creating a 'temp' node pointing at head
        return temp.value;      // Returning the value of the last element
    }
    ...
    public static void main(String[] args) {         // Main method
        ...
        GettingLastElement linkedList = new GettingLastElement();
        ...
        // Calling the method to retrieve the last element in the linked list
