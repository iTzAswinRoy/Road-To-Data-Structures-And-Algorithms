...
public class WS14 {      // Creating a class for stack
    ...
    public void swapElements(int e1, int e2) {          // Method to swap elements in the stack
    ...
    public static void main(String[] args) {        // Main method
        WS14 obj = new WS14(5);         // Creating an object of the class by passing a value
