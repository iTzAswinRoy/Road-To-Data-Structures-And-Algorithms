...
public class WS6 {      // Creating a class for stack
    ...
    public static void main(String[] args) {        // Main method
        WS6 obj = new WS6(5);       // Creating an object of the class by passing a value
